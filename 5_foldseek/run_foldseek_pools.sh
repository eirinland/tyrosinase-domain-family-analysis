#!/usr/bin/env bash
#SBATCH --job-name=fs_pools
#SBATCH --account=nn1003k
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --mem=64G
#SBATCH --time=24:00:00
#SBATCH --output=foldseek_pools_%j.log
...
echo "============================================"
echo " FoldSeek Clustering — POOLS ONLY (canonical + non-canonical)"
echo "============================================"
...
BASE = "/cluster/work/projects/nn1003k/eirin/bioinf/Super_reference_pipeline/foldseek/pools"
