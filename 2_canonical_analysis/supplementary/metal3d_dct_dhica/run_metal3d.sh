...
#SBATCH --output=/cluster/work/projects/nn1003k/eirin/bioinf/bioinf_redo/2_canonical_analysis/supplementary/metal3d_dct_dhica/metal3d_%j.log
...
done < "$SUBMITDIR/structure_list.txt"
...
apptainer exec --nv --cleanenv \
    ...
    python3 "$RUNNER" \
        --cif-dir "$STAGING" \
        --output "$SUBMITDIR/metal3d_results.tsv"
